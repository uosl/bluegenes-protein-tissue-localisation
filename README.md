...
Bluegenes Protein Tissue Localisation is a tool made for [BlueGenes](http://bluegenes.apps.intermine.org) following BlueGenes Tool API.
...
1. Clone the repo
2. `cd bluegenes-protein-tissue-localisation` and then `npm install` to install dependencies.
